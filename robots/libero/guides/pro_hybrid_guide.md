...
|---|---|---|
| how launched | oracle-state run | `zetta/cli/main.py --libero-type pro` (or `LIBERO_TYPE=pro`); perception artifacts always dumped, coords withheld |
...
```bash
python zetta/cli/main.py --env libero --suite <suite> --task <n> --seed <k> \
